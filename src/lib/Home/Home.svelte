<script>
  ...
  import EarthCanvas from "../ThreeScenes/EarthCanvas.svelte";
...
<main bind:this={main}>
  <header bind:this={header} class="con-header">
    ...
    <p bind:this={header_para}>
      Explore the world's magnificent seven wonders, recognized for
      awe-inspiring design, scale, and technological sophistication - a
      testament to human ingenuity and the unrelenting pursuit of progress.
    </p>
    <button bind:this={header_btn} on:click={toggleFullscreen}
